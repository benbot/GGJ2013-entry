...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("graphics/walkingBaby.png",loader1);
	ApplicationMain.total++;
	var loader2 = new browser.display.Loader();
	ApplicationMain.loaders.set("gfx/debug/console_debug.png",loader2);
	ApplicationMain.total++;
	var loader3 = new browser.display.Loader();
	ApplicationMain.loaders.set("gfx/debug/console_logo.png",loader3);
	ApplicationMain.total++;
	var loader4 = new browser.display.Loader();
	ApplicationMain.loaders.set("gfx/debug/console_output.png",loader4);
	ApplicationMain.total++;
	var loader5 = new browser.display.Loader();
	ApplicationMain.loaders.set("gfx/debug/console_pause.png",loader5);
	ApplicationMain.total++;
	var loader6 = new browser.display.Loader();
	ApplicationMain.loaders.set("gfx/debug/console_play.png",loader6);
	ApplicationMain.total++;
	var loader7 = new browser.display.Loader();
	ApplicationMain.loaders.set("gfx/debug/console_step.png",loader7);
	ApplicationMain.total++;
	...
	if(ApplicationMain.total == 0) ApplicationMain.begin(); else {
		...
		while( $it0.hasNext() ) {
			...
			loader9.load(new browser.net.URLRequest(path));
		}
...
entities.Player = function(posX,posY) {
	...
	this.sprite = new com.haxepunk.graphics.Spritemap(Assets.walkingBaby,284,421);
	this.sprite.add("walkDown",[3,5,4,5],4,true);
	this.sprite.add("walkUp",[0,2,1,2],4,true);
	this.sprite.add("stand",[5],0,false);
	this.sprite.scale = .3;
	this.setGraphic(this.sprite);
...
entities.Player.prototype = $extend(com.haxepunk.Entity.prototype,{
	update: function() {
		...
		if(this.moveVec.x == 0 && this.moveVec.y == 0) this.sprite.play("stand");
		{
...
entities.enemies.Chaser = function(x,y) {
	...
	this.x = x;
	this.y = y;
	var tempImage = new com.haxepunk.graphics.Image(Assets.baby);
	this.setGraphic(tempImage);
	{
...
world.TestWorld = function() {
	...
	this.add(new entities.enemies.Chaser(100,100));
};
